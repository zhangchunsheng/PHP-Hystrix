...
class Config implements Countable, Iterator, ArrayAccess {
    ...
    /**
     * Magic function to that $obj->value will work.
     *
     * @param string $name
     * @return mixed
     */
    ...
    /**
     * Deep clone of this instance to ensure that nested Luomor\Configs are also
     * cloned.
     *
     * @return void
     */
