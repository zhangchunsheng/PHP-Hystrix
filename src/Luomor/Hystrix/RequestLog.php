...
class RequestLog {
     ...
     *
     * @param \Luomor\Hystrix\AbstractCommand $command
     */
     ...
     *
     * If a command has a multiplier such <code>x4</code>, that means this command was executed 4 times with the same events. The time in milliseconds is the sum of the 4 executions.
     *
